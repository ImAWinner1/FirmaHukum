      ...
      <main className="flex flex-1 items-center justify-center p-6 text-center">
        <div className="max-w-2xl space-y-8">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row pt-4">
            <Link href="/">
              <Button size="lg" className="w-full bg-gold-600 px-8 text-navy-950 hover:bg-gold-500 sm:w-auto">
                Kembali ke Beranda
              </Button>
            </Link>
            <Link href="/kontak">
              <Button size="lg" variant="outline" className="w-full border-gray-600 bg-transparent px-8 text-white hover:border-gold-500 hover:bg-gold-600/10 hover:text-gold-400 sm:w-auto">
                Hubungi Kami
              </Button>
            </Link>
          </div>
